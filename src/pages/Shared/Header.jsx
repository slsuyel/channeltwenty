    ...
    <>
      <div className="w-100 mx-auto custom-bg position-relative">
        <div className="text-center ">
          ...
          <button
            onClick={handleMobileSocial}
            className="d-block d-sm-none btn"
          ...
          >
            ...
            <img
              src="https://tools-suyel.netlify.app/assets/qr-scanning-22cb3eea.gif"
              alt=""
              width={130}
            />
          </div>
          ...
          <div
            ...
            style={{ position: 'absolute', right: '18px', top: '32px' }}
          >
            <span className="hover">
              {' '}
              App <i className="fa-solid fa-download"></i>
            </span>
          </div>
        </div>
      </div>
