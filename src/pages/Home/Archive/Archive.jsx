  ...
  return (
    <div>
      <div className="d-flex justify-content-between mx-3 my-2 align-items-center gap-3">
        <div className="border-1 border-bottom border-secondary-subtle w-100"></div>
        <div>
          <a
            href="/"
            className="text-nowrap bg-red p-1 p-2 rounded text-decoration-none text-white "
          >
            পুরনো সাইট দেখতে ক্লিক করুন
          </a>
        </div>
      </div>
      ...
      <div className="row w-100 mx-auto">
          ...
          <form onSubmit={handleSubmit} className="row mx-auto ">
            ...
            <div className="mb-3 col-md-2">
              <button
                disabled={loader}
                type="সাবমিট"
                className="btn btn-danger rounded-1 w-100"
              >
        ...
        <div className="col-md-3">
          ...
          <div className="text-center">
            {' '}
            <img
              src="https://backend.newsnow24.com/storage/photos/shares/Ads/kishwan.gif"
              alt=""
              className="img-fluid"
            />
          </div>
